...
% function starts receive loop that waits for messages received by the process
receiver(Proc_num,Count_Rec,Count_Sender,SystemPID,Broadcast)-> 
  receive
	...
	% new message service routine added which counts the number of 
	% messages sent by a particular process (including rebroadcasts)
